...
Ensured 100% data reliability by performing:
...
Import the .sql files into your MySQL Workbench.

Run the schema modification queries first to set up the environment.
